...
const Intro = () => {
  return (
    <Wrapper>
      ...
      <DescriptionField
        text={
          "Ингосстрах собрал для тебя 11 фактов о космической сфере. Угадаешь, какие из них правдивы? Если успешно пройдешь тест, будут все шансы составить конкуренцию Илону Маску"
        }
      />
